...
const {Product, User, Review, Category, Order} = sequelize.models;
// Aca vendrian las relaciones

// Relacion Usuario con ordenes
...
Product.belongsTo(Category, {foreignKey: { name: 'idCategory', allowNull: false, }, })
